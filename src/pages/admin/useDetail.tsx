        ...
        <main className="mt-[-20px] flex-grow bg-gray-100">
          <div className="bg-white p-8 shadow-lg rounded-lg">
            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    disabled
                    type="text"
                    value={data.sex === "1" ? "Nam" : data.sex === "0" ? "Nữ" : "Khác"}
                    className="mt-2 w-full p-3 border rounded-lg focus:border-indigo-500 focus:ring-indigo-500"
                  />
                </div>
              </div>
              ...
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4 text-gray-700">Danh sách địa chỉ giao hàng</h3>
                    ...
                    <tbody>
                      {data.shipping_addresses.map((address: any, index: any) => (
                        <tr key={index} className="hover:bg-gray-50">
                          <td className="px-4 py-2 border">{address.receiver_name || "N/A"}</td>
                          <td className="px-4 py-2 border">{address.phone || "N/A"}</td>
                          <td className="px-4 py-2 border">{address.city || "N/A"}</td>
                          <td className="px-4 py-2 border">{address.district || "N/A"}</td>
                          <td className="px-4 py-2 border">{address.commune || "N/A"}</td>
                          <td className="px-4 py-2 border">{address.address || "N/A"}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
