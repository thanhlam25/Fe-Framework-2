                   ...
                   <div className="mx-[5%]">
                    ...
                    <nav>
                        <div className="flex gap-4 mt-[20px]">
                            <div className="text-base"><a href="?action=home">Trang chủ</a></div>
                        ...
                        <div className="p-8 w-[300px] font-bold border rounded-tl-[40px] rounded-br-[40px] border-gray-700 h-auto mt-8 ml-16 ">
                            ...
                            <hr />
                                <ul>
                                    ...
                                    <li className="px-4 py-2">
                                    <div className="pb-6 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-3 h-3 text-gray-500">
                                    ...
                                    <li className="px-4 py-2">
                                    <div className="pb-6 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="w-3 h-3 text-gray-500">
                                    ...
                                    <li className="px-4 py-2">
                                    <div className="pb-6 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black">
                                    <svg className="w-3 h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>
                        ...
                        <div className=" mt-8">
                            <div className="flex justify-between">
                                ...
                                <button className="rounded-tl-xl rounded-br-xl border-2 p-2 flex bg-black hover:bg-white text-white hover:text-black text-[18px] mr-20 hover:border-2 hover:border-black ">
                                    <svg className="w-5 h-5 border-2 border-white  rounded-full p-1 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="#ffffff" className=""  d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32
